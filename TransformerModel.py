...
from ImagePositionPatchEmbedding import ImagePosEmbed
# from ConvImagePositionPatchEmbedding import ConvImagePosEmbed
# from Conv2DImagePositionPatchEmbedding import Conv2DImagePosEmbed
...
class VisionTransformer:
    def __init__(self, input_shape, batch_size, patch_num, proj_dim, num_heads, stack_num, dropout, model="ViT"):
        """
    ...
    def ViT(self):
        ...
        embedding_layer = ImagePosEmbed(self.batch_size, self.patch_num, self.proj_dim)
